...
async def cmd_help(message: Message) -> None:
    ...
    help_text = (
        ...
        "*/file_put <путь> <alias>* - Копировать файл\n"
        "_Копирует файл в alias-директорию (downloads, desktop, documents)_\n\n"
        "*/file_move <путь> <alias>* - Переместить файл\n"
        "_Перемещает файл в alias-директорию_\n\n"
        "*/file_list <alias> [pattern]* - Список файлов\n"
        "_Показывает файлы в alias-директории (можно фильтровать по шаблону)_\n\n"
